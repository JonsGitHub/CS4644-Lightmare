...
namespace StateMachine.Editor
{
	internal class TransitionTableEditorWindow : EditorWindow
	{
		...
		private static readonly string _uxmlPath = "Assets/_Scripts/Editor/StateMachine/TransitionTableEditorWindow.uxml";
		private static readonly string _ussPath = "Assets/_Scripts/Editor/StateMachine/TransitionTableEditorWindow.uss";
		private bool _doRefresh;

		private UnityEditor.Editor _transitionTableEditor;

		[MenuItem("Transition Table Editor", menuItem = "AdditionalTools/Transition Table Editor")]
