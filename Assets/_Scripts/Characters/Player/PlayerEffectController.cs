...
{
	[SerializeField] private ParticleSystem _walkingParticles = default;
	[SerializeField] private ParticleSystem _landParticles = default;
	[SerializeField] private ParticleSystem _jumpParticles = default;
